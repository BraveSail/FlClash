...
as String,directoryId: null == directoryId ? _self.directoryId : directoryId // ignore: cast_nullable_to_non_nullable
as String,hubUrl: null == hubUrl ? _self.hubUrl : hubUrl // ignore: cast_nullable_to_non_nullable
as String,hubToken: null == hubToken ? _self.hubToken : hubToken // ignore: cast_nullable_to_non_nullable
as String,hubViaProxy: null == hubViaProxy ? _self.hubViaProxy : hubViaProxy // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
class _AppSettingProps implements AppSettingProps {
  const _AppSettingProps({this.locale, @JsonKey(fromJson: dashboardWidgetsSafeFormJson)  List<DashboardWidget> dashboardWidgets = defaultDashboardWidgets, this.onlyStatisticsProxy = false, this.showNotificationStopAction = true, this.autoLaunch = false, this.silentLaunch = false, this.autoRun = false, this.openLogs = false, this.closeConnections = true, this.testUrl = defaultTestUrl, this.isAnimateToPage = true, this.autoCheckUpdate = true, this.showLabel = false, this.disclaimerAccepted = false, this.crashlyticsTip = false, this.crashlytics = false, this.minimizeOnExit = true, this.hidden = false, this.developerMode = false, this.restoreStrategy = RestoreStrategy.compatible, this.showTrayTitle = true, this.checkCertificate = true, this.customUserAgent = '', this.directoryId = '', this.hubUrl = '', this.hubToken = '', this.hubViaProxy = false}): _dashboardWidgets = dashboardWidgets;
...
@override@JsonKey() final  String directoryId;
@override@JsonKey() final  String hubUrl;
@override@JsonKey() final  String hubToken;
@override@JsonKey() final  bool hubViaProxy;
